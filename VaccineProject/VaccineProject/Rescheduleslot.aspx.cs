...
namespace VaccineProject
{
    public partial class Rescheduleslot : System.Web.UI.Page
    {
        ...
        protected void Btnrebook_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("UPDATE BookForVaccine SET DatetimeID = @datetimeid WHERE BookingId = @Bookingid", con);

            cmd.Parameters.AddWithValue("@datetimeid", DDLId.Text);
